...
public class App_v2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job = new int[jobCount][machineCount];
    ...
    private static void JobMaker(int index) {
        // scans a job and makes it
        System.out.println("Enter Job " + (index + 1) + " with commas:");
        Scanner sc = new Scanner(System.in);
        ...
        for (int i = 0; i < machineCount; i++) {
            job[index][i] = Integer.parseInt(strArr[i]);
        }
